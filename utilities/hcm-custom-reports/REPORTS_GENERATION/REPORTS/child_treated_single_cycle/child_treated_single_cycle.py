...
# === CONSTANTS ===
ES_PROJECT_TASK_INDEX = "http://elasticsearch-master.es-cluster.svc.cluster.local:9200/project-task-index-v1/_search"
ES_INDIVIDUAL_INDEX = "http://elasticsearch-master.es-cluster.svc.cluster.local:9200/individual-index-v1/_search"
ES_SCROLL_API = "http://elasticsearch-master.es-cluster.svc.cluster.local:9200/_search/scroll"
ES_HOUSEHOLD_MEMBER_INDEX = "http://elasticsearch-master.es-cluster.svc.cluster.local:9200/household-member-index-v1/_search"
