...
ES_TRANSFORMED_ATTENDANCE_REGISTER_INDEX = 'http://elasticsearch-master.es-cluster.svc.cluster.local:9200/demo-transformed-attendance-register-index-v1/_search'
ES_ATTENDANCE_LOG_INDEX = 'http://elasticsearch-master.es-cluster.svc.cluster.local:9200/demo-attendance-log-index-v1/_search'
ES_PROJECT_STAFF_INDEX = "http://elasticsearch-master.es-cluster.svc.cluster.local:9200/demo-project-staff-index-v1/_search"
