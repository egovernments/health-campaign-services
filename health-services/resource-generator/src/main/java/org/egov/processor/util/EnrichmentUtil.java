...
//        String rootTenantId = centralInstanceUtil.getStateLevelTenant(request.getPlanConfiguration().getTenantId());
    ...
    public void enrichsheetWithApprovedCensusRecords(Sheet sheet, PlanConfigurationRequest planConfigurationRequest, String fileStoreId, Map<String, String> mappedValues, Map<String, String> BCodeToFacilityDetails, Map<String, Object> BCodeToAccessiblityDetails) {
        ...
        for(Row row: sheet) {
            ...
            if (census != null) {
                ...
                // if accessibilityDetails are present in census, adding it to the BCode to accessibilityDetails map
                Object accessibilityDetails = (Object) parsingUtil.extractFieldsFromJsonObject(census.getAdditionalDetails(), ACCESSIBILITY_DETAILS);
                if(accessibilityDetails != null)
                    BCodeToAccessiblityDetails.put(boundaryCode, accessibilityDetails);
            }
