...
import digit.web.models.Condition;
...
public class Activity {
    ...
    public Activity addDependenciesItem(String dependenciesItem) {
    ...
    public Activity addConditionsItem(Condition conditionsItem) {
