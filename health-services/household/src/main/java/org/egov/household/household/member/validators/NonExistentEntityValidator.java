...
@Order(value = 4)
@Slf4j
public class NonExistentEntityValidator implements Validator<HouseholdMemberBulkRequest, HouseholdMember> {

    private final HouseholdMemberRepository householdMemberRepository;

    @Autowired
    public NonExistentEntityValidator(HouseholdMemberRepository householdMemberRepository) {
