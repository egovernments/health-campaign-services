...
@Order(value = 5)
@Slf4j
public class RowVersionValidator implements Validator<HouseholdMemberBulkRequest, HouseholdMember> {

    private final HouseholdMemberRepository householdMemberRepository;

    @Autowired
    public RowVersionValidator(HouseholdMemberRepository householdMemberRepository) {
