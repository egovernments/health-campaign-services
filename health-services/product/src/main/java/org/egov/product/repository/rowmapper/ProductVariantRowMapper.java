    ...
    public ProductVariant mapRow(ResultSet resultSet, int i) throws SQLException {
        try {
            return ProductVariant.builder()
                    ...
                    .expiryDate(resultSet.getObject("expirydate") != null ? resultSet.getLong("expirydate") : null)
                    .baseUnit(resultSet.getString("baseunit"))
                    .netContent(resultSet.getObject("netcontent") != null ? resultSet.getLong("netcontent") : null)
