...
public class HouseholdService {
     ...
     * @return The Household object, or null if not found
     */
    public Household searchHouseholdById(String householdId, String tenantId) {
        ...
        try {
            ...
            if (response != null && response.getHouseholds() != null
                ...
                log.info("Found household: {}", householdId);
                return response.getHouseholds().get(0);
            }

            log.warn("Household not found: {}", householdId);
            return null;
     ...
     * @param tenantId The tenant ID
     * @return The HouseholdMember who is the head, or null if not found
     */
    public HouseholdMember searchHouseholdHead(String householdId, String tenantId) {
        ...
        try {
            ...
            if (response != null && response.getHouseholdMembers() != null
                ...
                log.info("Found household head for household: {}", householdId);
                return response.getHouseholdMembers().get(0);
            }

            log.warn("Household head not found for household: {}", householdId);
            return null;
