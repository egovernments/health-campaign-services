...
import { getCampaignNumber, createAndUploadFile, getSheetData, createExcelSheet, getAutoGeneratedBoundaryCodesHandler, createBoundaryEntities, createBoundaryRelationship, getMDMSV1Data, getTargetSheetDataAfterCode, callMdmsTypeSchema, getSheetDataFromWorksheet, getTargetWorkbook } from "../api/genericApis";
...
async function autoGenerateBoundaryCodesForGeoJson(request: any, localizationMap?: any) {
    ...
    console.log(boundaryData,hierarchy, boundaryMap);
}
