...
const BATCH_SIZE_KEYS: Record<string, [string, number]> = {
  ...
  'user.hrmsFallbackMaxRetries': ['USER_HRMS_FALLBACK_MAX_RETRIES', 2],
  'user.hrmsFallbackBackoffMs': ['USER_HRMS_FALLBACK_BACKOFF_MS', 500],
  'user.hrmsFallbackWindowDelayMs': ['USER_HRMS_FALLBACK_WINDOW_DELAY_MS', 200],
