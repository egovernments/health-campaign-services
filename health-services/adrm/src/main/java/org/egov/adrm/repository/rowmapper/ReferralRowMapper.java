    ...
    public Referral mapRow(ResultSet resultSet, int i) throws SQLException {
        try {
            ...
            return Referral.builder()
                    ...
                    .referringPartyClientReferenceId(resultSet.getString("referringpartyclientreferenceid"))
                    .referredToId(resultSet.getString("referredToId"))
                    .referredToClientReferenceId(resultSet.getString("referredtoclientreferenceid"))
