...
/**
 * Core Spring configuration: ObjectMapper beans, timezone, HTTP converter, and Redis.
 * Mirrors the project service's MainConfiguration so shared conventions stay identical.
 */
