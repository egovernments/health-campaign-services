...
public class MicroplanProcessor implements IGenerateProcessor {
    ...
    public MicroplanProcessor(ExcelIngestionConfig config,
            ...
            CellProtectionManager cellProtectionManager, ExcelDataPopulator excelDataPopulator, BoundaryColumnUtil boundaryColumnUtil) {
        this.config = config;
    ...
    public byte[] generateExcel(GenerateResource generateResource, RequestInfo requestInfo) throws IOException {
        ...
        boundaryColumnUtil.addBoundaryColumnsToSheet(workbook, actualFacilitySheetName, mergedLocalizationMap, 
        ...
        if (userSchemaJson != null && !userSchemaJson.isEmpty()) {
            ...
            boundaryColumnUtil.addBoundaryColumnsToSheet(workbook, actualUserSheetName, mergedLocalizationMap,
                                    generateResource.getBoundaries(), hierarchyType, tenantId, requestInfo);
        }
