...
@Slf4j
public abstract class NewProjectTaskTransformationService implements TransformationService<Task> {
    ...
    @Autowired
    protected NewProjectTaskTransformationService(ProjectTaskIndexV1Transformer transformer,
    ...
    public List<ProjectTaskIndexV1> transformNew(List<Task> payloadList) {
