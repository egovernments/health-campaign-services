...
import org.egov.referralmanagement.service.enrichment.AdverseEventEnrichmentService;
        ...
        try {
            if (!validAdverseEvents.isEmpty()) {
                ...
                adverseEventRepository.save(validAdverseEvents,
                        referralManagementConfiguration.getCreateAdverseEventTopic());
    ...
    public List<AdverseEvent> update(AdverseEventBulkRequest adverseEventRequest, boolean isBulk) {
        ...
        try {
            if (!validAdverseEvents.isEmpty()) {
                ...
                adverseEventRepository.save(validAdverseEvents,
                        referralManagementConfiguration.getUpdateAdverseEventTopic());
        ...
        try {
            if (!validAdverseEvents.isEmpty()) {
                ...
                adverseEventRepository.save(existingAdverseEvents,
                        referralManagementConfiguration.getDeleteAdverseEventTopic());
