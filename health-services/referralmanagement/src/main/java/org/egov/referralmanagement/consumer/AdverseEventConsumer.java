...
public class AdverseEventConsumer {
    ...
    @KafkaListener(topics = "${referralmanagement.adverseevent.consumer.bulk.create.topic}")
    ...
    @KafkaListener(topics = "${referralmanagement.adverseevent.consumer.bulk.update.topic}")
    ...
    @KafkaListener(topics = "${referralmanagement.adverseevent.consumer.bulk.delete.topic}")
