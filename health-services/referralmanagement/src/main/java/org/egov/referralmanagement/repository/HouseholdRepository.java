...
public class HouseholdRepository {
	...
	private HouseholdRowMapper householdRowMapper;
	 ...
	 public Tuple<Long, List<Household>> findByView (String localityCode, Integer limit, Integer offset, String tenantId) {
	    	...
	    	String query = "select * from " + tenantId + ". household_address_mv where localitycode=:localitycode and rank between :start and :end ";
	        ...
	        Integer maxRank = namedParameterJdbcTemplate.queryForObject("select max(rank) from  " + tenantId + ".household_address_mv where localitycode=:localitycode", paramsMapCount, Integer.class);
