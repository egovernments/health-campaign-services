...
import org.egov.individual.validators.household.HCommunityTypeValidator;
import org.egov.individual.validators.household.HCommunityValidator;
import org.egov.individual.validators.household.HExistentEntityValidator;
import org.egov.individual.validators.household.HHouseholdTypeChangeValidator;
import org.egov.individual.validators.household.HIsDeletedValidator;
import org.egov.individual.validators.household.HNonExistentEntityValidator;
import org.egov.individual.validators.household.HNullIdValidator;
import org.egov.individual.validators.household.HRowVersionValidator;
import org.egov.individual.validators.household.HUniqueEntityValidator;
...
public class HouseholdService {
    ...
    private final IndividualProperties householdConfiguration;
    ...
    public HouseholdService(HouseholdRepository householdRepository, IdGenService idGenService,
                            IndividualProperties householdConfiguration, List<Validator<HouseholdBulkRequest, Household>> validators, HouseholdEnrichmentService enrichmentService) {
    ...
    public List<Household> create(HouseholdBulkRequest request, boolean isBulk) {
        ...
        try {
            if (!validEntities.isEmpty()) {
                ...
                householdRepository.save(validEntities, householdConfiguration.getCreateHouseholdTopic());
            ...
            populateErrorDetails(request, errorDetailsMap, validEntities, exception, Constants.SET_HOUSEHOLDS);
        }
    ...
    public SearchResponse<Household> search(HouseholdSearch householdSearch, Integer limit, Integer offset, String tenantId,
        ...
        if (isSearchByIdOnly(householdSearch, idFieldName)) {
            ...
            try {
                ...
                throw new CustomException(Constants.TENANT_ID_EXCEPTION, e.getMessage());
            }
    ...
    public List<Household> update(HouseholdBulkRequest request, boolean isBulk) {
        ...
        try {
            if (!validEntities.isEmpty()) {
                ...
                householdRepository.save(validEntities, householdConfiguration.getUpdateHouseholdTopic());
    ...
    public List<Household> delete(HouseholdBulkRequest request, boolean isBulk) {
        ...
        try {
            if (!validEntities.isEmpty()) {
                ...
                householdRepository.save(validEntities, householdConfiguration.getDeleteHouseholdTopic());
