...
import static org.egov.individual.util.CommonUtils.getHouseholdMemberIdFieldForHouseholdIdMethod;
...
public class HouseholdMemberEnrichmentService {
    ...
    public void enrichHousehold(List<HouseholdMember> householdMembers) throws InvalidTenantIdException {
        ...
        Method householdIdField = getIdMethod(householdMembers, HOUSEHOLD_ID_FIELD, HOUSEHOLD_CLIENT_REFERENCE_ID_FIELD);
        String columnName = getHouseholdMemberIdFieldForHouseholdIdMethod(householdIdField);
        log.info("getting houseHoldIds for householdMembers");
        List<String> houseHoldIds = getIdList(householdMembers, householdIdField);
