...
@Controller
    ...
    private final IndividualService individualService;
        ...
        this.servletRequest = servletRequest;
                ...
                public ResponseEntity<IndividualResponse> individualV1SearchPost(@ApiParam(value = "Individual details." ,required=true )  @Valid @RequestBody IndividualSearchRequest individual,@NotNull
    @Min(0)
