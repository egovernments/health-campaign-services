...
import org.egov.individual.validators.member.HmExistentEntityValidator;
import org.egov.individual.validators.member.HmHouseholdHeadValidator;
import org.egov.individual.validators.member.HmHouseholdValidator;
...
import org.egov.individual.validators.member.HmRelationshipTypeValidator;
...
import org.egov.individual.validators.member.HmUniqueIndividualValidator;
...
public class HouseholdMemberService {
    ...
    private final IndividualProperties householdMemberConfiguration;
        ...
        try {
            if (!validHouseholdMembers.isEmpty()) {
                ...
                householdMemberRepository.save(validHouseholdMembers,
                        householdMemberConfiguration.getCreateHouseholdMemberTopic());
            ...
            populateErrorDetails(householdMemberBulkRequest, errorDetailsMap, validHouseholdMembers,
                    exception, Constants.SET_HOUSEHOLD_MEMBERS);
        }
    ...
    public List<HouseholdMember> update(HouseholdMemberBulkRequest householdMemberBulkRequest, boolean isBulk) {
        ...
        try {
            if (!validHouseholdMembers.isEmpty()) {
                ...
                householdMemberRepository.save(validHouseholdMembers,
                        householdMemberConfiguration.getUpdateHouseholdMemberTopic());
    ...
    public List<HouseholdMember> delete(HouseholdMemberBulkRequest householdMemberBulkRequest, boolean isBulk) {
        ...
        try {
            if (!validHouseholdMembers.isEmpty()) {
                ...
                householdMemberRepository.save(validHouseholdMembers,
                        householdMemberConfiguration.getDeleteHouseholdMemberTopic());
    ...
    private Tuple<List<HouseholdMember>, Map<HouseholdMember, ErrorDetails>> validate(List<Validator<HouseholdMemberBulkRequest,
        ...
        Map<HouseholdMember, ErrorDetails> errorDetailsMap = CommonUtils.validate(validators,
                ...
                Constants.SET_HOUSEHOLD_MEMBERS);
