...
public class ServiceConstants {
    ...
    public static final String WORKFLOW_NOT_NULL_CODE = "WORKFLOW_NOT_NULL";
    public static final String WORKFLOW_NOT_NULL_MESSAGE = "Census workflow should be null for the provided role";
