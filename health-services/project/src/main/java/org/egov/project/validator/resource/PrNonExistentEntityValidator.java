...
@Order(value = 4)
@Slf4j
public class PrNonExistentEntityValidator implements Validator<TaskBulkRequest, Task> {
//shiva
    private final ProjectTaskRepository projectTaskRepository;

    @Autowired
    public PrNonExistentEntityValidator(ProjectTaskRepository projectTaskRepository) {
