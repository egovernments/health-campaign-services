...
public class ProjectApiController {
    ...
    public ResponseEntity<ProjectResponse> searchProject(
            ...
            @ApiParam(value = "Used in project search API to specify if response should be one which is in the preceding hierarchy of matched projects.") @Valid @RequestParam(value = "includeAncestors", required = false, defaultValue = "false") boolean isAncestorProjectId
    ) {
