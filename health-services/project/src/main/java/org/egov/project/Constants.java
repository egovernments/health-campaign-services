...
public interface Constants {
    ...
    String USER_ACTION_ENRICHMENT_ERROR = "USER_ACTION_ENRICHMENT_ERROR";

    String LOCATION_CAPTURE_USER_ACTION_ENRICHMENT_ERROR = "LOCATION_CAPTURE_USER_ACTION_ENRICHMENT_ERROR";
