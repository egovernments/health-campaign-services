...
public class ProjectResourceApiController {
    ...
    public ResponseEntity<ProjectResourceBulkResponse> resourceV1SearchPost(@ApiParam(value = "Search linkage of Project and resource.", required = true) @Valid @RequestBody
    ProjectResourceSearchRequest projectResource, @NotNull
    @Min(0)
