...
import static digit.error.ErrorCode.ATTRIBUTE_CODE_UNIQUENESS_ERR_CODE;
import static digit.error.ErrorCode.ATTRIBUTE_CODE_UNIQUENESS_ERR_MSG;
import static digit.error.ErrorCode.INVALID_ATTRIBUTE_DEFINITION_ERR_CODE;
import static digit.error.ErrorCode.INVALID_ATTRIBUTE_DEFINITION_ERR_MSG;
import static digit.error.ErrorCode.INVALID_REGEX_ERR_CODE;
import static digit.error.ErrorCode.INVALID_REGEX_ERR_MSG;
import static digit.error.ErrorCode.SERVICE_DEFINITION_ALREADY_EXISTS_ERR_CODE;
import static digit.error.ErrorCode.SERVICE_DEFINITION_ALREADY_EXISTS_ERR_MSG;
